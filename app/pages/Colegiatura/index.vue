...
export default {
  data() {
    return {
      ...
      options: [
        { value: '1000', text: '$1,499 a $2,500' },
        { value: '2000', text: '$2,501 a $4,000' },
        { value: '3000', text: '$4,001 a $6,500' },
        { value: '4000', text: 'más de $6,500' },
      ],
    }
  },
  computed: {
  ...
  created() {
    this.form.price = this.getPrice ? this.getPrice : 'init'
    setTimeout(() => {
      this.showIntro = true
    }, 300)
  },
  methods: {
    onSubmit() {
      if (this.form.price !== 'init') {
        this.$store.commit('setPrice', this.form.price)
        this.$router.push({
          path:
            '/personal?type=' +
            this.getType +
